...
export default function BoardInterstitial({ names, colors, locks, total, justLocked }: BoardInterstitialProps) {
  ...
  return (
    <div className="board-in fixed inset-0 z-30 flex flex-col items-center overflow-y-auto bg-[var(--bg)]/97 px-4 py-8 backdrop-blur-md">
      ...
      <h2 className="display mb-6 text-center text-2xl sm:text-3xl">
